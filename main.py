...
if selected == "Implementation":
    ...
    accelerations = st.sidebar.number_input("accelerations =", min_value=0, max_value=1)
    fetal_movement = st.sidebar.number_input("fetal_movement =", min_value=0 , max_value=1)
    uterine_contractions = st.sidebar.number_input("uterine_contractions =", min_value=0, max_value=1)
    light_decelerations = st.sidebar.number_input("light_decelerations =", min_value=0, max_value=1)
    severe_decelerations = st.sidebar.number_input("severe_decelerations =", min_value=0 ,max_value=0)
    prolongued_decelerations = st.sidebar.number_input("prolongued_decelerations =", min_value=0, max_value=1)
    abnormal_short_term_variability = st.sidebar.number_input("abnormal_short_term_variability =", min_value=12, max_value=87)
    mean_value_of_short_term_variability = st.sidebar.number_input("mean_value_of_short_term_variability =", min_value=0, max_value=7)
